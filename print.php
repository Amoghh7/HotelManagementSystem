...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>CONRAD,</p>
				<p>Conrad Pune, 7, Mangaldas Rd, Sangamvadi<br>Pune,<br>Maharashtra</p>
				<p>+91 1234567890</p>
			</address>
			<span><img alt="" src="assets/img/CH.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@conrad.com || Web :- www.conrad.com || Phone :- +91 1234567890 || Made By: Raghav Dube (raghav.22111348@viit.ca.in) </p>
			</div>
		</aside>
	</body>
</html>
